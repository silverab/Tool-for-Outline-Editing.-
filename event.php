	...
	<div class="container mt-5">
		<div class="jumbotron">
		  <h1 class="text-center">Outline Editor</h1>
			<button class="bold"><i class="fa fa-bold"></i></button>
			<button onclick="execCmd('bold');"><i class="fa fa-bold"></i></button>
			<button class="italic"><i class="fa fa-italic"></i></button>
			<button onclick="execCmd('italic');" class="italic"><i class="fa fa-italic"></i></button>
